...
const en = {
  ...
  "restore.alreadyExists": "That receipt is already back in the ledger.",
  "restore.notRestorable": "There is no saved copy of this receipt to restore.",
...
const mr: Record<MessageKey, string> = {
  ...
  "restore.alreadyExists": "ही पावती आधीच नोंदवहीत आहे.",
  "restore.notRestorable": "ही पावती पुन्हा आणण्यासाठी जतन केलेली प्रत नाही.",
